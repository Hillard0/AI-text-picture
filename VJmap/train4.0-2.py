...
def extract_coordinates_and_texts(filename, bbox, vertical_shift):
    coordinates = {
        "points": [],
        "lines": [],
        "lwpolylines": [],
            ...
            for entity in msp:
                if entity.dxftype() == 'POINT':
                    ...
                    if is_inside_bbox(text_location, bbox):
                        ...
                        matched_texts.append(text_info)
                    ...
                    if is_inside_bbox(mtext_location, bbox):
                        ...
                        matched_texts.append(mtext_info)

            if not matched_texts:
                bbox = (bbox[0], bbox[1] + vertical_shift, bbox[2], bbox[3] + vertical_shift)
            else:
                coordinates["matched_texts"] = matched_texts
...
vertical_shift = int(input("Enter the vertical shift distance: "))

# Extract coordinates and texts within the bounding box and save to a JSON file
coords = extract_coordinates_and_texts(r"C:\Users\Lenovo\Desktop\水闸纵剖面图\cad解析\9#口门水工施工图.dxf", bbox, vertical_shift)
if coords:
